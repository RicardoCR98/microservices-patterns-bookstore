...
// Hacer que el setter de offerPrice se calcule automaticamente
// Verificar los filtros del fronted
// Revisar la carga inicial de productos
// Revisar to={`/api/product/details/${id}`}
//